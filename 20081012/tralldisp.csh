#!/bin/csh
#/bin/cp /Volumes/HD1/hawaii-burp/invdata/ALLTHINGSDECON/dstg40tdisp .
#/bin/cp /Volumes/HD1/hawaii-burp/invdata/ALLTHINGSDECON/refg40tdisp .
...
r BYL.HHE.sac BYL.HHN.sac BYL.HHZ.sac
 ...
 rmean 
 trans from polezero s dstg40tdisp to none freq 0.002 0.01 35. 45. 
...
/usr/local/sac/bin/sac << SACDONE >! /dev/null 
 ...
 rmean 
 trans from polezero s refg40tdisp to none freq 0.002 0.01 35. 45. 
 mul 1.98625e-09
 chnhdr file 1 cmpaz 90
 chnhdr file 1 cmpinc 90
 chnhdr file 2 cmpaz 0 
